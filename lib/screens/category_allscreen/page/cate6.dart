...
class Cate6 extends StatefulWidget {
  static var routeName = '/cate6';

  const Cate6({Key key}) : super(key: key);

  @override
  State<Cate6> createState() => _Cate6State();
}

class _Cate6State extends State<Cate6> {
  ...
  Future<Null> readApiProduct() async {
    var url = Uri.parse('${ConfigIp.domain}/products/category/Candy');
