...
class Cate4 extends StatefulWidget {
  static var routeName = '/cate4';

  const Cate4({Key key}) : super(key: key);

  @override
  State<Cate4> createState() => _Cate4State();
}
...
class _Cate4State extends State<Cate4> {
  ...
  Future<Null> readApiProduct() async {
    var url = Uri.parse('${ConfigIp.domain}/products/category/เครื่องดื่ม');
