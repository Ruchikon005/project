...
class Cate3 extends StatefulWidget {
  static var routeName = '/cate3';

  const Cate3({Key key}) : super(key: key);

  @override
  State<Cate3> createState() => _Cate3State();
}
...
class _Cate3State extends State<Cate3> {
  ...
  Future<Null> readApiProduct() async {
    var url = Uri.parse('${ConfigIp.domain}/products/category/เบเกอรี่');
